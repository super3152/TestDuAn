...
import static GUI.jdlSizeColor.cbbMau;
 ...
 * @author KMB1604
 */
public class jdlthemmau extends javax.swing.JDialog {

    /**
     * Creates new form jdlthemsize
     */
    public jdlthemmau(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
          BLL.BLLSanPham.HienThiMau(tblmau);
    }
    ...
    private void initComponents() {
        ...
        jPanel38.add(txtTenMau, java.awt.BorderLayout.CENTER);
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
      ...
      String MoTa = txtMoTa.getText();
        if (BLL.BLLSanPham.KiemTraThemMau(TenMau,MoTa)){
            DTOMauSanPham mau = new DTOMauSanPham(TenMau);
            BLL.BLLSanPham.ThemMau(mau);
            ThongBaoCanhBao.ThongBao("Thêm màu thành công", "Thông báo");
               
  BLL.BLLSanPham.DoDuLieucbbMauSanPham(GUI.pnlsanpham.cbbmau);
            this.dispose();
        }
    ...
    private void jButton26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton26ActionPerformed
      int kq = JOptionPane.showConfirmDialog(new JFrame(), "Xác nhận xóa size này không?",
        ...
        if (kq == JOptionPane.YES_OPTION) {
          int cacDong[] = tblmau.getSelectedRows();
            for (int i = 0; i < cacDong.length; i++) {
                int XoaSize = Integer.parseInt(tblmau.getValueAt(cacDong[i], 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdlthemmau.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdlthemmau dialog = new jdlthemmau(new javax.swing.JFrame(), true);
